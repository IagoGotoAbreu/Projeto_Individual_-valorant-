...
function finishGame() {
  ...
  switch (true) {
    case acertos == 100:
      mensagem =
        'Radiante <img src="../assets/rank/radiante.png" style="width:40px; height:40px;">';
      break;
    case acertos == 90:
      mensagem =
        'Imortal <img src="../assets/rank/imortal.png" style="width:50px; height:50px;">';
      break;
    case acertos == 80:
      mensagem =
        'Ascendente <img src="../assets/rank/ascendente.png" style="width:40px; height:40px;">';
      break;
    case acertos == 70:
      mensagem =
        'Diamante <img src="../assets/rank/diamante.png" style="width:40px; height:40px;">';
      break;
    case acertos == 60:
      mensagem =
        'Platina <img src="../assets/rank/platina.png" style="width:40px; height:40px;">';
      break;
    case acertos == 50:
      mensagem =
        'Ouro <img src="../assets/rank/ouro.png" style="width:50px; height:50px;">';
      break;
    case acertos == 40:
      mensagem =
        'Prata <img src="../assets/rank/prata.png" style="width:50px; height:50px;">';
      break;
    case acertos == 30:
      mensagem =
        'Bronze <img src="../assets/rank/bronze.png" style="width:50px; height:50px;">';
      break;
    case acertos == 20:
      mensagem =
        'Ferro <img src="../assets/rank/ferro.png" style="width:40px; height:40px;">';
      break;
    case acertos == 10:
      mensagem =
        'Ferro <img src="../assets/rank/ferro.png" style="width:40px; height:40px;">';
...
const questions = [
  {
    question:
      "Pergunta 1/10 - Atualmente, existem quantos agentes em valorant?",
    answers: [
  ...
  {
    question:
      "Pergunta 9/10 - Qual o único time brasileiro que já ganhou o mundial?",
    answers: [
  ...
  {
    question:
      "Pergunta 10/10 - Qual foi o último time que ganhou o GameChangers no cenário inclusivo",
    answers: [
