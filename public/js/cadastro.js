...
function fechar() {
    if(ipt_senha.type == "password") {
        ipt_senha.type = "text";
        button_fechar.innerHTML = '<img id="img_fechar" src="../public/assets/img/olho-fechado.png">';
    } else {
        ipt_senha.type = "password";
        button_fechar.innerHTML = '<img id="img_fechar" src="../public/assets/img/olho-aberto.png">';
    }
}
function ocultar() {
